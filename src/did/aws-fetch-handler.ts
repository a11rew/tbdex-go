// Source: https://github.com/smithy-lang/smithy-typescript/blob/main/packages/fetch-http-handler/src/fetch-http-handler.ts
// Modified to remove cache option in fetch init which is not supported in workers
